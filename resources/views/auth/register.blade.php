            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="row mb-3">
                            <label for="no_sim" class="col-md-4 col-form-label text-md-end">Nomor SIM</label>
                            <div class="col-md-6">
                                <input id="no_sim" type="text"
                                    class="form-control @error('no_sim') is-invalid @enderror" name="no_sim"
                                    value="{{ old('no_sim') }}" required autocomplete="no_sim" autofocus>
